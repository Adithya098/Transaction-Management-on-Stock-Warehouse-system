...
column_names = ["w_id", "w_name", "w_street_1", "w_street_2", "w_city", "w_state", "w_zip", "w_tax", "w_ytd"]
...
try:
    ...
    df.to_sql("test_warehouses", engine, if_exists="append", index=False)
    print(df)
    conn.commit()
